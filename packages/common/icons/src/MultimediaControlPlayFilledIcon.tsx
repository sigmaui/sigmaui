...
function MultimediaControlPlayFilledIcon(props: IconProps) {
...
MultimediaControlPlayFilledIcon.displayName = 'MultimediaControlPlayFilledIcon';

export default MultimediaControlPlayFilledIcon;
