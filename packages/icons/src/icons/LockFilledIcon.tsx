...
const lockFilledSvg = (
  <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M18 12.8101C17.9998 12.4522 17.7249 12.2098 17.4443 12.2098H6.55566C6.27507 12.2098 6.00018 12.4522 6 12.8101V18.4151C6 18.7732 6.27498 19.0154 6.55566 19.0154H17.4443C17.725 19.0154 18 18.7732 18 18.4151V12.8101Z" />
  </svg>
);

const lockFilledIconDefinition = svgToIconDefinition(lockFilledSvg, 'lock-filled');
