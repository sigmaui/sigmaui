...
const multimediaControlPlayOutlinedSvg = (
...
const multimediaControlPlayOutlinedIconDefinition = svgToIconDefinition(
  multimediaControlPlayOutlinedSvg,
  'multimedia-control-play-outlined'
);

const RefIcon: React.ForwardRefExoticComponent<
  Omit<SmIconProps, 'ref'> & React.RefAttributes<HTMLSpanElement>
> = React.forwardRef<HTMLSpanElement, SmIconProps>((props, ref) => {
  return <SmIcon {...props} ref={ref} icon={multimediaControlPlayOutlinedIconDefinition} />;
});

if (process.env.NODE_ENV !== 'production') {
  RefIcon.displayName = 'MultimediaControlPlayOutlinedIcon';
}
