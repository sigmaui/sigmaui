...
const logoSigmaFilledSvg = (
  <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M13.9922 11.5617L11.4531 9.94916C11.1016 9.72414 10.5938 9.9866 10.5938 10.3991V13.6241C10.5938 14.0367 11.1016 14.2991 11.4531 14.0741L13.9922 12.4617C14.3437 12.2367 14.3437 11.7492 13.9922 11.5617Z" />
  </svg>
);

const logoSigmaFilledIconDefinition = svgToIconDefinition(logoSigmaFilledSvg, 'logo-sigma-filled');

const RefIcon: React.ForwardRefExoticComponent<
  Omit<SmIconProps, 'ref'> & React.RefAttributes<HTMLSpanElement>
> = React.forwardRef<HTMLSpanElement, SmIconProps>((props, ref) => {
  return <SmIcon {...props} ref={ref} icon={logoSigmaFilledIconDefinition} />;
});

if (process.env.NODE_ENV !== 'production') {
  RefIcon.displayName = 'LogoSigmaFilledIcon';
}
