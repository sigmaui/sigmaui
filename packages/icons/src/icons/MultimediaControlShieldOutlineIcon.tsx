...
const multimediaControlShieldOutlineSvg = (
...
const multimediaControlShieldOutlineIconDefinition = svgToIconDefinition(
  multimediaControlShieldOutlineSvg,
  'multimedia-control-shield-outline'
);

const RefIcon: React.ForwardRefExoticComponent<
  Omit<SmIconProps, 'ref'> & React.RefAttributes<HTMLSpanElement>
> = React.forwardRef<HTMLSpanElement, SmIconProps>((props, ref) => {
  return <SmIcon {...props} ref={ref} icon={multimediaControlShieldOutlineIconDefinition} />;
});

if (process.env.NODE_ENV !== 'production') {
  RefIcon.displayName = 'MultimediaControlShieldOutlineIcon';
}
