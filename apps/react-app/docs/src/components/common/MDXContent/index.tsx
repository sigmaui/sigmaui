...
import { type MDXContentProps, styles } from './styles';
...
export const getMDXComponent = (code: string, globals: Record<string, unknown> = {}): React.FC<MDXComponentProps> => {
...
const MDXContent: FC<MDXContentProps> = ({ prefixCls = 'sm-mdx-content', className, classes, code }) => {
